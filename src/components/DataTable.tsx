...
export const columns: ColumnDef<Payment>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => (
      <Button
        variant="ghost" className="text-black border-black"
  ...
  {
    accessorKey:"date",
    header :() =><div className="text-center rounded-2xl">Requested Date</div>,
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const amount1 = parseFloat(row.getValue("amount").toString());
        ...
        <Table>
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-24 text-center text-slate-200">
                  No results.
                </TableCell>
              </TableRow>
            )}
